...
def get_args_parser():
    ...
    parser.add_option('--lr', type=float, default=5e-4, metavar='LR',
    ...
    parser.add_option("--unknown_label", dest="unknown_label", help="the label assigned to unknown data",
                      default=0, type="int")
    parser.add_option("--individual", dest="individual", action="store_true", default=False, help="use individual coef schedule (constant zero)")
